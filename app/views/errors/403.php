...
<head>
    ...
    <title><?= e($code ?? '403') ?> - <?= e($title ?? 'Forbidden') ?></title>
...
<body class="bg-slate-50">
    <main class="min-h-screen w-full flex flex-col justify-center items-center px-6 py-12">
        <div class="max-w-lg text-center">
            <div class="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-rose-100 ring-4 ring-rose-50 mb-6">
                <?= icon('lock-closed', 'h-8 w-8 text-rose-600', 'solid') ?>
            </div>
